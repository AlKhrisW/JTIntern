        ...
        <div class="filter-stats-bar d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
            ...
            <div class="stats-group d-flex gap-4">
                <div class="stat-item text-end">
                    ...
                    <div class="stat-value text-primary fw-bold">{{ $totalLowongan ?? 0 }}</div>
                </div>
                <div class="stat-item text-end">
                    <div class="stat-label">LOWONGAN AKTIF</div>
                    <div class="stat-value text-success fw-bold">{{ $totalLowonganAktif ?? 0 }}</div>
                </div>
                <div class="stat-item text-end">
                    <div class="stat-label">LOWONGAN DITUTUP</div>
                    <div class="stat-value text-danger fw-bold">{{ $totalLowonganSelesai ?? 0 }}</div>
                </div>
            </div>
        </div>
