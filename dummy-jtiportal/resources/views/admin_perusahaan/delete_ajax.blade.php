    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 440px;">
        <div class="modal-content modal-perusahaan">
            ...
            <div class="modal-body text-center p-4">
                ...
                <h5 class="fw-bold mb-1">Hapus Perusahaan?</h5>
                <p class="text-muted mb-3" style="font-size: 0.9rem;">
                    Kamu akan menghapus perusahaan berikut secara permanen:
                </p>
                ...
                <div class="delete-company-card mb-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="text-start">
                            <div class="fw-semibold">{{ $perusahaan->nama_perusahaan }}</div>
                            <div class="text-muted small">{{ $perusahaan->jenis_perusahaan }} &bull; {{ $perusahaan->lokasi }}</div>
                        </div>
                    </div>
                </div>
...
.delete-icon-wrap { display: flex; justify-content: center; }
.delete-icon-outer {
...
.delete-logo-placeholder {
    ...
    font-weight: 700; font-size: 0.88rem; color: #2e7d32;
}

.btn-modal-cancel {
    background: #f5f5f5; color: #555; border: none;
    padding: 0.55rem 1.3rem; border-radius: 8px; font-weight: 500;
}
...
.btn-modal-delete:hover { background: #b71c1c; color: #fff; }
</style>