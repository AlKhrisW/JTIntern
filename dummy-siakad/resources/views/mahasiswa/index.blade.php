                    ...
                    <tbody>
                        @forelse($mahasiswas as $mhs)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge badge-prodi">{{ $mhs->programStudi->nama_prodi ?? '-' }}</span>
                                </td>
                                <td class="text-end">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btnTambah').addEventListener('click', function() {
                loadModal('{{ route('mahasiswa.create') }}');
            });

            // Tombol Show, Edit, Delete
            document.querySelectorAll('.btn-show').forEach(btn => {
                btn.addEventListener('click', function() {
                    loadModal('{{ url('mahasiswa/show') }}/' + this.dataset.id);
                });
            });

            document.querySelectorAll('.btn-edit').forEach(btn => {
                btn.addEventListener('click', function() {
                    loadModal('{{ url('mahasiswa/edit') }}/' + this.dataset.id);
                });
            });

            document.querySelectorAll('.btn-delete').forEach(btn => {
                btn.addEventListener('click', function() {
                    loadModal('{{ url('mahasiswa/delete') }}/' + this.dataset.id);
                });
            });
